  ...
  <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-5">
    ...
    <div className="bg-white w-full max-w-3xl rounded-3xl p-8 relative max-h-[90vh] overflow-y-auto">
      ...
      <button
        ...
        className="sticky top-0 bg-red-500 text-white w-10 h-10 rounded-full text-2xl"
      >
        ×
      </button>

      <h2 className="text-4xl font-bold text-sky-700 mb-8 mt-3">
...
<div className="mt-10">
 ...
 selectedCity !== "القاهرة" && (
  <div className="mt-5 bg-yellow-100 border-2 border-yellow-500 text-yellow-900 rounded-2xl p-5 text-center font-bold text-lg">

    ⚠️ ملحوظة هامة

    <br /><br />

    جميع المحافظات خارج القاهرة
    يلزم دفع عربون 50 جنيه
    عن طريق فودافون كاش أو إنستا باي
    لتأكيد الأوردر.
